...
public class Game {
    public static void main(String[] args)
    {
        ...
        while (playAgain.equals("Y"))
        {
            ...
            getUserInput(game, input, gameBoard, turn);
    ...
    private static void getUserInput(String game, Move input, Board gameBoard, int turn) {
        input.setTurn(turn);

        if (game.equals("3")) {
            input.findLegalMoves(input.getPieceType(), gameBoard);
            gameBoard.setLegalMoves(input.getLegalMoves());
            gameBoard.setForceMoves(input.getForceMoves());
        }
